...
<body>
	...
	<form name="addnewteacher" action="addnewteacher" method="post">
		...
		<fieldset>
			<legend>
				<span class="number">1</span>Add New Teacher
			</legend>
		...
		<fieldset>
			<label for="job">Subject</label> <select id="subject" name="subject"
				required>
				<optgroup label="">
					<option value="Networking">Networking</option>
					<option value="Cryptography">Cryptography</option>
					<option value="Introduction To Media">Introduction To
						Media</option>
		...
		<fieldset>
			<label for="type">Type</label> <input type="radio" id=""
				value="Coordinator" name="iscoordinator"><label
				class="light" for="">Co-ordinator</label>&nbsp&nbsp&nbsp <input
				type="radio" id="" value="Teacher" name="iscoordinator"><label
				class="light" for="">Teacher</label>
		</fieldset>
